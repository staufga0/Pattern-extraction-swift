...
// pe.applyToAll("swift_files/files/a1", "./GR2_out_data8.json", "./GRall_keys8.txt")
...
// pe.applyToAll("swift_files/files/b1", "./GR2_out_data1.json", "./GRall_keys1.txt")
// pe.applyToAll("swift_files/files/b2", "./GR2_out_data2.json", "./GRall_keys2.txt")
// pe.applyToAll("swift_files/files/b3", "./GR2_out_data3.json", "./GRall_keys3.txt")
// pe.applyToAll("swift_files/files/b4", "./GR2_out_data4.json", "./GRall_keys4.txt")
